function MenuEditor(e, s) {
    ...
    function f(e) {
        $("<span>").addClass("sortableListsOpener " + s.opener.openerClass).css(s.opener.openerCss).on("mousedown touchstart", function (e) {
            var t = $(this).closest("li");
            return t.hasClass("sortableListsClosed") ? t.iconOpen(s) : t.iconClose(s), !1
        }).prependTo(e.children("div").first()), e.hasClass("sortableListsOpen") ? e.iconOpen(s) : e.iconClose(s)
    }
    ...
    t.sortableLists(l.listOptions), c.on("change", function (e) {
        ...
        var s = u(),
            ...
            o = $("<div>").css({
                overflow: "auto"
            }).append(n).append("&nbsp;").append(l).append(s),
            r = $("<li>").data(e);
